...
@register_env("PokeCube-v2", max_episode_steps=200)
class PokeCubeV2Env(BaseEnv):
    SUPPORTED_ROBOTS = ["panda", "panda_pokecube"]
    agent: Panda
    ...
    def __init__(self, *args, robot_uids="panda_pokecube", robot_init_qpos_noise=0.02, **kwargs):
        self.robot_init_qpos_noise = robot_init_qpos_noise
        super().__init__(*args, robot_uids=robot_uids, **kwargs)

    @property
    def _default_sensor_configs(self):
        pose = sapien_utils.look_at(eye=[0.45, 0.3, 0.25], target=[0.15, 0.0, 0.1])
        return [CameraConfig("base_camera_x", pose, 128, 128, 1, 0.01, 100)]
    ...
    def _get_obs_extra(self, info: Dict):
        obs = dict(
            ...
            goal_region_pose=self.goal_region.pose.raw_pose,
    ...
    def evaluate(self):
        ...
        return {
            "is_obj_up": is_peg_grasped,
            "is_obj_on_bin": is_peg_cube_fit,
            "success": success,
